...
from wtforms import EmailField, PasswordField, SubmitField, StringField, TextAreaField, FileField, BooleanField, SelectField
...
class ProfilesForm(FlaskForm):
    ...
    corp_brand = StringField("상호명", validators=[Length(min=1, max=100)], render_kw={"placeholder": "상호명"})
