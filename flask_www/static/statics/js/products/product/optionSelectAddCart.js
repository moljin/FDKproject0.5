...
function productOptionCountPriceInit () {
    try {
        ...
        document.addEventListener("click", function (e) {
            // console.log("cancel click", e.target)
            let target = e.target;
            if (target.classList.contains("op-cancel")) {
                ...
                console.log("postCancelTotalPrice", postCancelTotalPrice)
                ...
                totalPriceSpan.innerHTML = intComma(postCancelTotalPrice);
            }
        }, false);
    } catch (e) {
        // console.log(e);
...
function pdOpTotalPriceCalc () {
    ...
    console.log("Number(opTotalPriceCalc())", Number(opTotalPriceCalc()))
...
function cancelOpTotalPrice(_id) {
    ...
    console.log("op-cancel", Number(opTotalPrice.value))
