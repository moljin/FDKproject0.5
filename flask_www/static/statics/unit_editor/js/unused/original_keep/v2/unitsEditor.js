...
function setSlider(percentages) { // 여기는 첫 셋팅, mediaResize 안에거는 변하는 값에 관한 것이다.
    ...
    document.querySelector(".units-content").style.cssText = `margin-top: 45px`;
...
<div class="units-btn-group is-subgroup-add  heading-font-size-group">
...
<div class="units-btn-group typing-group">
    <span class="units-btn">
...
<div class="units-btn-group spell-group">
    <span class="units-btn">
...
const unitsMoreEdit = `
<div class="units-btn-group edit-group">
    <span class="units-btn">
...
<div class="units-btn-group keyboard-group">
    <span class="units-btn">
...
<div class="units-btn-group ellipsis-group">
    <span class="units-btn">
...
const unitsMoreSort = `
<div class="units-btn-group sort-group">
    <span class="units-btn">
...
<div class="units-btn-group hamburg-group">
    <span class="units-btn">
...
const unitsMorePlus = `
<div class="units-btn-group plus-group">
    <span class="units-btn">
...
const unitsMoreHome = `
<div class="units-btn-group home-group">
    <span class="units-btn">
